...
class Brand {
  ...
  async updateBrandByAdminData(updated_data) {
    console.log("Brand:update:", updated_data);
    try {
  ...
  //get chosen Shop data
  async getChosenShopData(member, id) {
    try {
      id = shapeIntoMongooseObjectId(id);

      //increase views if member has not seen the target before
